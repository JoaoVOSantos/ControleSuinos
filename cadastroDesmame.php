...
<head>
	...
	<title>CL | Cadastro de Desmame</title>
</head>
...
<body style="background-color: pink;">
  ...
  <a class="navbar-brand" style="margin-right: 1220px; font-weight: bold;">
    ...
    Controle de Suinos - Cadastro de Desmame
  </a>
</nav>
	<form method="POST" action="cadDesmame.php">
		...
		<div class="container">
          ...
          <div class="form-group col-md-4">
            ...
            <input type="date" class="form-control" id="inputEmail4" placeholder="Data Desmame" name="dt_desmame">
          </div>
           <br>
          ...
          <div class="form-group col-md-6">
            ...
            <input type="number" class="form-control" id="inputEmail4" placeholder="Numero Lote" name="num_lote">
			    ...
			    <div class="form-group col-md-6">
			      ...
			      <input type="text" class="form-control" id="inputEmail4" placeholder="Peso Medio" name="peso_med">
			    </div>
