...
<head>
	...
	<title>CL | Cadastro de Gestações</title>
</head>
...
<body style="background-color: pink;">
  ...
  <a class="navbar-brand" style="margin-right: 1220px; font-weight: bold;">
    ...
    Controle de Suinos - Cadastro de Gestação
  </a>
</nav>



	<form method="POST" action="cadGestacao.php">
		...
		<div class="container">
			<div class="content">
				...
				">Cadastro de Gestação</h2></center>
				  <br>  <br> 
			    ...
			    <div class="form-group col-md-4">
			      ...
			      <input type="number" class="form-control" id="inputEmail4" placeholder="Numero Matriz" name="nMatriz">
			    </div>
			  ...
			  <div class="form-group col-md-4">
			      ...
			      <input type="text" class="form-control" id="inputEmail4" placeholder="Medicamentos" name="med">
			    </div>

			
			    <div class="form-group col-md-4">
			      <label for="inputEmail4">Vacinas</label>
			      <input type="text" class="form-control" id="inputEmail4" placeholder="Vacinas" name="vac">
			    </div>
			  
			    <br>
			  <div class="form-group col-md-4">
			      <label for="inputEmail4">Data de Cobertura</label>
			      <input type="date" class="form-control" id="inputEmail4" placeholder="" name="dtCobert">
			    </div>
			  </div>
