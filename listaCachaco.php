...
<head>
	...
	<title>CL | Lista de Cachaços</title>
</head>
<body>
...
<?php
	...
	$resultado = mysqli_query($conexao, "select * from cachaco");
...
function confirmacao(id) {
     ...
     if (resposta == true) {
          window.location.href = "excluircachaco.php?cod_cachaco="+id;
     }else if (resposta == false){
      window.location.href = "listaCachaco.php";
     }
}
</script>
...
<nav class="accordion arrows">
	<header class="box">
      <label for="acc-close" class="box-title">Lista de Cachaço</label>
    </header>
    ...
    <?php  
  				...
  				for($i=0; $i<mysqli_num_rows($resultado); $i++){
  					...
  					$cod_cachaco = $mostra['cod_cachaco'];
    ...
    <section class="box">
      <label class="box-title" for="<?php echo $id; ?>" ><font>Cachaço | Cobertura: <?php echo("$cobert");?></font></label>
    ...
    <input type="submit" value="Editar" style="background-color: rgba(30, 100, 200, 0.8); color: white; box-shadow: 0 0 0 0; border: 0 none; outline: 0; height: 30px; width: 60px; border-radius: 6px; cursor: pointer; margin-left:2px; ">
				...
				<a class="btn btn-primary" href="editacachaco.php?cod_cachaco=<?php echo("$cod_cachaco"); ?>"  style="background-color: rgba(30, 100, 200, 0.8); color: white; border-radius: 2px; cursor: pointer; padding: 6px; text-decoration: none; border-radius: 3px; margin-left: 6px; justify-content: center;"role="button">Editar</a>

		
				<a class="btn btn-primary" href="#" style="background-color: rgba(255, 20, 30, 0.8); color: white; border-radius: 2px; cursor: pointer; padding: 6px; text-decoration: none;  border-radius: 3px; margin-left: 6px;  justify-content: center;"role="button" onclick="confirmacao(<?php echo("$cod_cachaco"); ?>)">Excluir</a> <br>
