...
<head>
	...
	<title>CL | Cadastro de Matriz</title>
</head>
...
<body style="background-color: pink;">
  ...
  <a class="navbar-brand" style="margin-right: 1220px; font-weight: bold;">
    ...
    Controle de Suinos - Cadastre sua Matriz
  </a>
</nav>



	<form method="POST" action="cadMatriz.php">
			...
			<div class="content">
				...
				">Cadastro de Matriz</h2></center>
				 ...
				 <center>
			      ...
			      <input type="date" class="form-control" id="inputEmail4" placeholder="Data" name="dtComp">
			    </div>
			  ...
			  <div class="form-group col-md-4">
			      ...
			      <input type="number" class="form-control" id="inputEmail4" placeholder="Brinco" name="brinco">
			    </div>


        <div class="form-group col-md-4">
            <label for="inputEmail4">Lote da mossa</label>
            <input type="text" class="form-control" id="inputEmail4" placeholder="Lote" name="lmos">
          </div>


			    <div class="form-group col-md-4">
			      <label for="inputEmail4">Raça</label>
			      <input type="text" class="form-control" id="inputEmail4" placeholder="Raça" name="raca">
			    </div>
