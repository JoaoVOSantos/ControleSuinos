...
<head>
	...
	<title>CL | Lista de Terminação</title>
</head>
<body>
...
<?php
	...
	$resultado = mysqli_query($conexao, "select * from terminacao");
...
function confirmacao(id) {
     ...
     if (resposta == true) {
          window.location.href = "excluirterm.php?cod_term="+id;
     }else if (resposta == false){
      window.location.href = "listaTerm.php";
     }
}
</script>
...
<nav class="accordion arrows">
    ...
    <section class="box">
      <label class="box-title" for="<?php echo $id; ?>" ><font>Terminação | Data do Abate: <?php echo("$dta");?></font></label>
      ...
      <div class="box-content">
      	...
      	<font>Data de Terminação: <?php echo("$dtt");?></font>
      	<br>
