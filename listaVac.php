...
<head>
	...
	<title>CL | Lista de Vacinas</title>
</head>
<body>
...
<?php
	...
	$resultado = mysqli_query($conexao, "select * from vacinas");
...
function confirmacao(id) {
     ...
     if (resposta == true) {
          window.location.href = "excluirvac.php?cod_vac="+id;
...
<nav class="accordion arrows">
	<header class="box">
      <label for="acc-close" class="box-title">Lista de Vacinas</label>
    </header>
    ...
    <section class="box">
      <label class="box-title" for="<?php echo $id; ?>" ><font>Vacinas | Lote de Vacinas: <?php echo("$lote");?></font></label>
      <label class="box-close" for="acc-close"></label>
      <div class="box-content">

      	<font>Nome da Vacina: <?php echo("$nome");?></font>
      	<br>
    ...
    <input type="submit" value="Editar" style="background-color: rgba(30, 100, 200, 0.8); color: white; box-shadow: 0 0 0 0; border: 0 none; outline: 0; height: 30px; width: 60px; border-radius: 6px; cursor: pointer; margin-left:2px; ">
				...
				<a class="btn btn-primary" href="editavac.php?cod_vac=<?php echo("$cod_vac"); ?>"  style="background-color: rgba(30, 100, 200, 0.8); color: white; border-radius: 2px; cursor: pointer; padding: 6px; text-decoration: none; border-radius: 3px; margin-left: 6px; justify-content: center;"role="button">Editar</a>
		
				<a class="btn btn-primary" href="#" style="background-color: rgba(255, 20, 30, 0.8); color: white; border-radius: 2px; cursor: pointer; padding: 6px; text-decoration: none;  border-radius: 3px; margin-left: 6px;  justify-content: center;"role="button" onclick="confirmacao(<?php echo("$cod_vac"); ?>)">Excluir</a> <br>
