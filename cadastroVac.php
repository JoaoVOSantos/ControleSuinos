...
<head>
	...
	<title>CL | Cadastro de Vacinas</title>
</head>
...
<body style="background-color: pink;">
  ...
  <a class="navbar-brand" style="margin-right: 1220px; font-weight: bold;">
    ...
    Controle de Suinos - Cadastro de Vacinas
  </a>
</nav>



	<form method="POST" action="cadVac.php">  
		...
		<div class="container">
			<div class="content">
			  ...
			  <div class="form-group col-md-4">
			      ...
			      <input type="number" class="form-control" id="inputEmail4" placeholder="Numero Lote" name="lote_vac">
			    </div>
			    <div class="form-group col-md-4">
			      <label for="inputEmail4">Fabricante</label>
			      <input type="text" class="form-control" id="inputEmail4" placeholder="Nome Fabricante" name="fabric">
			    </div>
          <div class="form-group col-md-4">
            <label for="inputEmail4">Data de Chegada</label>
            <input type="date" class="form-control" id="inputEmail4" placeholder="Data" name="dt_cheg">
          </div>
          <div class="form-group col-md-4">
            <label for="inputEmail4">Data de Validade</label>
            <input type="date" class="form-control" id="inputEmail4" placeholder="Data" name="dt_valid">
          </div>
			    <br><br>
