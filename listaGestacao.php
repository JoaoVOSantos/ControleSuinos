...
<head>
	...
	<title>CL | Lista de Gestação</title>
</head>
<body>
...
<?php
	...
	$resultado = mysqli_query($conexao, "select * from gestacao");
...
function confirmacao(id) {
     ...
     if (resposta == true) {
          window.location.href = "excluirgestacao.php?cod_gestacao="+id;
...
<nav class="accordion arrows">
	<header class="box">
      <label for="acc-close" class="box-title">Lista de Gestação</label>
    </header>
    ...
    <section class="box">
      <label class="box-title" for="<?php echo $id; ?>" ><font>Gestação | Brinco Matriz: <?php echo("$nu");?></font></label>
      <label class="box-close" for="acc-close"></label>
      <div class="box-content">

      	<font>Data da Cobertura: <?php echo("$dtcob");?></font>
      	<br>

      	<font>Vacinas: <?php echo("$vac");?></font>
      	<br>
    ...
    <input type="submit" value="Editar" style="background-color: rgba(30, 100, 200, 0.8); color: white; box-shadow: 0 0 0 0; border: 0 none; outline: 0; height: 30px; width: 60px; border-radius: 6px; cursor: pointer; margin-left:2px; ">
				...
				<a class="btn btn-primary" href="editagestacao.php?cod_gestacao=<?php echo("$cod_gestacao"); ?>"  style="background-color: rgba(30, 100, 200, 0.8); color: white; border-radius: 2px; cursor: pointer; padding: 6px; text-decoration: none; border-radius: 3px; margin-left: 6px; justify-content: center;"role="button">Editar</a>
