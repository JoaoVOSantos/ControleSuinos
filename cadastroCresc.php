...
<head>
	...
	<title>CL | Cadastro de Crescimento</title>
</head>
...
<body style="background-color: pink;">
  ...
  <a class="navbar-brand" style="margin-right: 1220px; font-weight: bold;">
    ...
    Controle de Suinos - Cadastro Crescimento
  </a>
</nav>
	<form method="POST" action="cadCresc.php">
		...
		<div class="container">
			<div class="content">
				...
				">Cadastro de Crescimento</h2></center>
				  <br>  <br> 

				 <center>
			  <div class="form-group col-md-4">
			      <label for="inputEmail4">Data de Crescimento</label>
			      <input type="date" class="form-control" id="inputEmail4" placeholder="Data" name="dt_cresc">
			    </div>
