...
<head>
	...
	<title>CL | Cadastro de Cachaço</title>
</head>
...
<body style="background-color: pink;">
  ...
  <a class="navbar-brand" style="margin-right: 1220px; font-weight: bold;">
	...
	<form method="POST" action="cadCachaco.php">  
		...
		<div class="container">
			<div class="content">
			  ...
			  <div class="form-group col-md-4">
			      ...
			      <input type="number" class="form-control" id="inputEmail4" placeholder="Cobertura" name="num_corbe">
			    </div>
			    <div class="form-group col-md-4">
